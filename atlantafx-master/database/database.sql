...
CREATE TABLE `bill` (
                        ...
                        CONSTRAINT `bill_ibfk_1` FOREIGN KEY (`table_id`) REFERENCES `tables` (`id`),
                        CONSTRAINT `bill_ibfk_2` FOREIGN KEY (`payment_method_id`) REFERENCES `payment_method` (`id`) ON DELETE CASCADE
...
CREATE TABLE `bill_detail` (
                               ...
                               CONSTRAINT `bill_detail_ibfk_1` FOREIGN KEY (`bill_id`) REFERENCES `bill` (`id`) ON DELETE CASCADE,
...
INSERT INTO `tables` VALUES (1,'Table A1',3),(2,'Table A2',3),(3,'Table A3',3),(4,'Table A4',3),(5,'Table A5',2),(6,'Table A6',3),(7,'Table A7',3),(8,'Table A8',3),(9,'Table A9',1),(10,'Table A10',3),(11,'Table A11',3),(12,'Table A12',3),(13,'Table A13',3),(14,'Table A14',3),(15,'Table A15',3),(16,'Table A16',3),(17,'Table A17',3),(18,'Table A18',3),(19,'Table A19',3),(20,'Table A20',3),(21,'Table A21',1),(22,'Table A22',3),(23,'Table A23',3),(24,'Table A24',3);
