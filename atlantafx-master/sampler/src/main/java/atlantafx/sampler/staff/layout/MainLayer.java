...
import atlantafx.sampler.staff.event.HotkeyEvent;
import atlantafx.sampler.staff.event.PageEvent;
...
import static atlantafx.sampler.staff.event.PageEvent.Action;
...
class MainLayer extends BorderPane {
    ...
    private void createView() {
        sidebar.setMinWidth(StaffApp.SIDEBAR_WIDTH);
        sidebar.setMaxWidth(StaffApp.SIDEBAR_WIDTH);
