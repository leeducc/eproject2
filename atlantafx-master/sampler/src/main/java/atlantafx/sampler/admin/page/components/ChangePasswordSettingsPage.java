...
public class ChangePasswordSettingsPage extends OutlinePage {
    public static final String NAME = "Change Username and Password";
    ...
    public ChangePasswordSettingsPage() {
        super();
        initializeUI();
    }
    ...
    private boolean updateCredentials(String newUsername, String currentPassword, String newPassword) {
        try (Connection conn = JDBCConnect.getJDBCConnection()) {
            ...
            String query = "SELECT password_hash FROM admin WHERE id = 1"; // assuming admin ID is 1
            try (PreparedStatement stmt = conn.prepareStatement(query);
                ...
                if (rs.next()) {
                    ...
                    if (PasswordUtils.checkPassword(currentPassword, hashedPassword)) {
                        ...
                        String updateQuery = "UPDATE admin SET username = ?, password_hash = ? WHERE id = 1";
