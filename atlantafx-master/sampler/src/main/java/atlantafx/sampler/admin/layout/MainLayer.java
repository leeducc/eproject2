...
import static atlantafx.sampler.admin.event.PageEvent.Action;
import static javafx.scene.layout.Priority.ALWAYS;

import atlantafx.sampler.admin.event.DefaultEventBus;
import atlantafx.sampler.admin.event.HotkeyEvent;
import atlantafx.sampler.admin.event.PageEvent;
...
class MainLayer extends BorderPane {
    ...
    private void createView() {
        sidebar.setMinWidth(AdminApp.SIDEBAR_WIDTH);
        sidebar.setMaxWidth(AdminApp.SIDEBAR_WIDTH);
