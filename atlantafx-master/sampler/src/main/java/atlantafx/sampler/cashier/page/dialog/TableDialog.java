...
//    private ObservableList<Products> addedProducts = FXCollections.observableArrayList(); // List of added products
...
//    private Map<Products, Integer> productQuantityMap = new HashMap<>(); // To track quantities
//
...
//    }
//
//    private void addProductToOrder(Products product, int quantity) {
...
//    }
//
//    private void removeProductFromOrder(Products product) {
...
//        List<Products> products = CashierService.loadProducts();
